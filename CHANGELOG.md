...
- Added explicit v1.5.2 calibration status note in `docs/balance-calibration-notes.md` clarifying that v1.5.2 is a patch release that does not modify balance parameters and all v1.5.1 calibration data remains valid.
...
- Enhanced design system visibility in `docs/NAVIGATION.md` with expanded description "(visual tokens, color palette, type scale)" and added `scripts/README.md` reference in Testing & validation section.
