...
### Changed
- Refocused landing + web-v1 integration around a brand-first first viewport (full-bleed hero image, reduced hero content budget, and explicit expedition entry CTA) and added intentional motion hierarchy for presence without UI noise.
