...
### Changed
- Executed an aggressive cross-surface visual redesign for all public HTML entry points by switching landing (`index.html`), markdown viewer (`md-viewer.html`), web-v1 token/base layers (`prototype/web-v1/css/tokens.css`, `prototype/web-v1/css/reset.css`, `prototype/web-v1/css/screens.css`, `prototype/web-v1/css/components.css`), and archived MRA viewer (`prototype/mra-v0/viewer/styles.css`) to a unified immersive neon-alpine semantic palette and elevated glass gradients.
