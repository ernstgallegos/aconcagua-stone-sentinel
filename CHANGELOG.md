...
- Simplified landing-page mountain context copy in `index.html` to a two-sentence geology/cultural summary and removed the Field Notes section heading intro block so the carousel content starts immediately.
