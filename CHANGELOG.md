...
- Added curated illustration support for the Part 2 Mendoza room scene by styling `.part2-visual-hotel-room` in `prototype/web-v1/css/screens.css` to use `art/concept-art/curated/ig/27.png`.
