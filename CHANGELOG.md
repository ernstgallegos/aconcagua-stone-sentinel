...
- Changed the public landing and `web-v1` presentation system with a coordinated editorial visual rebuild: new typography families, atmospheric gradient/token palette refresh, staged entrance animation cadence, and a new concept-art “Editorial traverse” section wired for EN/ES localization.
