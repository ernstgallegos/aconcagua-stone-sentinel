...
### Changed
- Reworked the public landing frontend composition (`index.html`) into a full-bleed mountain hero with stronger brand-first typography, simplified section surfaces, and motion-led visual hierarchy to reduce card-heavy clutter on desktop/mobile.
