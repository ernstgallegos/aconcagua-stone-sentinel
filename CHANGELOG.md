...
- Reframed first-view storytelling to prioritize brand and intent over metadata: landing hero now uses a full-bleed atmospheric composition with brand-first hierarchy and reduced CTA set, while web-v1 title screen now presents explicit project framing before run start.
