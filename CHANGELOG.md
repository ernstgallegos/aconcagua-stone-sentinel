...
### Changed
- Rebuilt the root `index.html` landing surface with a full-bleed hero composition, stronger hero-level branding, atmospheric alpine art direction, and simplified one-purpose sections while preserving EN/ES language switching and canonical public CTAs.
