...
### Changed
- Reworked `/index.html` into a full-bleed, brand-led landing composition with an edge-to-edge hero image, typography overhaul (`Cormorant Garamond` + `Manrope`), reduced first-viewport content, and intentional motion cues for headline/CTA/hero presence across desktop and mobile.
