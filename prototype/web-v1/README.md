# Prototype Web v1.5.1 (public state)
...
> - Current public build is **v1.5.1 (public phased rollout)** with shipped phase slices and stabilized release documentation.
