...
import { CURRENT_LANGUAGE } from './i18n.js';
...
export function getDifficultyModifiers(id = CURRENT_DIFFICULTY_ID) {
...
export function difficultyLabel(id = CURRENT_DIFFICULTY_ID, lang = CURRENT_LANGUAGE) {
  const cfg = getDifficultyConfig(id);
  return cfg.label[lang] || cfg.label.en;
}

export function setCurrentDifficultyId(id) { CURRENT_DIFFICULTY_ID = id; }
