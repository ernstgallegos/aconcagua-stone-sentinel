...
const I18N = {
  en: {
    ...
    ui: {
      ...
      clearLog: 'Clear log',
      titleKicker: 'Mountain-first narrative simulation',
  ...
  es: {
    ...
    ui: {
      ...
      titleKicker: 'Simulación narrativa con enfoque de montaña',
...
function applyStaticTranslations() {
  const map = [
    ...
    ['#screen-title .title-screen-advance span', 'ui.beginExpedition'],
