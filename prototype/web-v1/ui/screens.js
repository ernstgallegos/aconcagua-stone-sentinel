...
const I18N = {
  en: {
    ...
    ui: {
      ...
      titleKicker: 'Mountain-first narrative prototype',
      titleSummary: 'Read pressure, manage body tolerance, and decide when to continue or retreat.',
  ...
  es: {
    ...
    ui: {
      ...
      titleKicker: 'Prototipo narrativo mountain-first',
      titleSummary: 'Leé presión, gestioná tolerancia corporal y decidí cuándo seguir o retirarte.',
...
function applyStaticTranslations() {
  const map = [
    ...
    ['#screen-title .title-kicker', 'ui.titleKicker'],
    ['#screen-title .title-summary', 'ui.titleSummary'],
