...
const I18N = {
  en: {
    ...
    ui: {
      ...
      begin: 'BEGIN',
      titleBrandName: 'Aconcagua: Stone Sentinel',
      titleBrandSub: 'A mountain-first expedition prototype about pressure, judgment, and safe return.',
      titleBegin: 'Begin expedition',
  ...
  es: {
    ...
    ui: {
      ...
      begin: 'COMENZAR',
      titleBrandName: 'Aconcagua: Stone Sentinel',
      titleBrandSub: 'Un prototipo de expedición mountain-first sobre presión, criterio y retorno seguro.',
      titleBegin: 'Iniciar expedición',
...
function applyStaticTranslations() {
  const map = [
    ...
    ['#title-brand-name', 'ui.titleBrandName'],
    ['#title-brand-sub', 'ui.titleBrandSub'],
    ['#title-screen-advance-label', 'ui.titleBegin'],
