...
export const strings = {
  es: {
    ...
    summitSuccess: {
      heading: '¡CUMBRE ALCANZADA!',
      message: 'Has llegado a la cima del Aconcagua. 6.962 metros. El techo de América.',
      continueP2: 'CONTINUAR A PARTE 2 ▸',
      newExpedition: 'NUEVA EXPEDICIÓN',
      viewDebrief: 'VER RESUMEN',
    },
    part2: {
      heading: 'PARTE 2 — EL GRUPO',
      subtitle: 'Solo Francisco está disponible por ahora.',
      locked: 'Bloqueado',
      comingSoon: 'Parte 2 — Próximamente',
  ...
  en: {
    ...
    debrief: {
      ...
      outcomes: {
        ...
        'Collapse (Exposure)': 'Exposure Collapse',
    ...
    summitSuccess: {
      heading: 'SUMMIT REACHED!',
      message: 'You have reached the top of Aconcagua. 6,962 meters. The roof of the Americas.',
      continueP2: 'CONTINUE TO PART 2 ▸',
      newExpedition: 'NEW EXPEDITION',
      viewDebrief: 'VIEW DEBRIEF',
    },
    part2: {
      heading: 'PART 2 — THE GROUP',
      subtitle: 'Only Francisco is available for now.',
      locked: 'Locked',
      comingSoon: 'Part 2 — Coming Soon',
      back: '← Back to start',
