...
> Note: v1.4 documentation and planning are now partially implemented in the current public prototype. Check the changelog `v1.4.6` release block and implementation plan files for latest phase progress.
...
> - Live implementation status is tracked in `CHANGELOG.md` under `[1.4.6]`.
...
- `prototype/web-v1/`: active systemic prototype, node-to-node route, EP/BT/delta engine, and v1.4.6 mechanics currently in public rollout.
