...
| Missing audit artifacts referenced in release prompts (`AUDITORIA_ACONCAGUA_COMPLETA_2026-03-30.md`, `Adutoria_aconcagua_2.md`) | Release owner | Medium: closure matrix can become partially unverifiable | Prompt requests mention files not present in branch; remediation may rely on secondary summaries instead of canonical reports | Required audit markdown files are committed to repo (or linked as immutable artifact URLs) and referenced in `meta/audit-remediation-2026-03-30.md` |
