...
flowchart LR
  ...
  subgraph R3[R3 - Mental Load and Risk Perception (Reinforcing)]
    direction LR
...
- Avoid parentheses inside node text if you run into renderer differences.
- Prefer explicit semicolons (`;`) to prevent accidental inline parsing issues.
