...
- [`/docs/`](../docs/) — design, systems, narrative  
- [`/art/`](../art/) — visual references
...
For a visual and structural overview of these systems, see the documentation in  
[`/docs/`](../docs/).
...
- [`/meta/public-roadmap.md`](./public-roadmap.md) — sequencing and priorities  
- [`/docs/`](../docs/) — systems, design, narrative, legal, research  
