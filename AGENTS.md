...
- Full-surface redesign spikes are safer when delivered as additive standalone artifacts (`/index.html` + `/game.html`) while preserving canonical `prototype/web-v1` runtime paths for regression/stability workflows.
