...
- End-to-end visual overhauls are safer when driven first through shared token layers (`prototype/web-v1/css/tokens.css` + root/markdown viewer palettes), then refined in component states; this keeps aggressive style shifts coherent without touching resolver/runtime logic.
