...
- Cross-surface UX upgrades are safer when landing and web-v1 share one role-based typography contract (brand serif + UI sans + telemetry mono) and the first viewport prioritizes play CTA + model credibility signals before long-form context.
