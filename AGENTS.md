...
- Audit-remediation passes should record missing externally referenced audit files as explicit technical debt with reproducible search evidence, instead of silently assuming equivalent local documents.
