...
- Landing-to-prototype continuity improves when typography/color tokens are intentionally shared across `/` and `prototype/web-v1`; keeping the same display/ui/mono roles preserves trust after the Play CTA and avoids a perceived “second product” jump.
