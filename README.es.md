...
> Nota: la documentación/planificación v1.4 está completamente implementada hasta v1.5.0. Para el estado actual y el mapa de módulos, ver `docs/repo-truth.md` y el bloque `[1.5.0]` del CHANGELOG.
