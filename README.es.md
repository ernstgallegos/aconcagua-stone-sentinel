...
> Nota: la documentación/planificación v1.4 ya tiene implementación parcial en el prototipo público. Revisar `CHANGELOG.md` (bloque `1.4.3`) y los planes de implementación para el progreso real por fase.
...
## Estado canónico del prototipo (v1.4.3 estado público)

> **Estado canónico (anclado al código):**
> - El estado de implementación se rastrea en `CHANGELOG.md` bajo [`[1.4.3]`](./CHANGELOG.md#142--2026-03).
...
> - La versión pública actual es **v1.4.3 (despliegue público por fases)**.

El prototipo activo canónico es **`prototype/web-v1` (v1.4.3 estado público)**.

- `prototype/web-v1/`: prototipo sistémico activo, ruta nodo a nodo, engine EP/BT/delta, y mecánicas v1.4.3 en despliegue público.
